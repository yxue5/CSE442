...
DECLARE_MULTICAST_DELEGATE(FOnGameSparksNotConnected);
typedef FOnGameSparksNotConnected::FDelegate FOnGameSparksNotConnectedDelegate;
...
public:
	...
	void Initialize(FString apikey, FString secret, bool previewServer, bool clearCachedAuthentication, bool dontRetryAfterDisconnect);
	void Shutdown();
    void Logout();
	...
	void SendGameSparksNotConnectedToComponents();
	...
	DEFINE_ONLINE_DELEGATE(OnGameSparksNotConnected);
